...
-- -----------------------------------------------------------------------------
-- RangeCheck (LibRangeCheck removed)
-- MSUF now uses the native C_Spell.EnableSpellRangeCheck + SPELL_RANGE_CHECK_UPDATE
-- flow (see MidnightSimpleUnitFrames.lua). We keep this stub for backwards
-- compatibility with older refactors that still call MSUF_EnsureLibRangeCheck().
-- -----------------------------------------------------------------------------
